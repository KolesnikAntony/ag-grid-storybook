...
const Grid = (props) => {
  ...
  const columnDefs = [
    { field: 'id', filter: 'agNumberColumnFilter', filterParams: { buttons: ['reset', 'apply'], suppressAndOrCondition: true } },
    { field: 'make' },
    { field: 'model' },
    { field: 'price' },
    { field: 'date', filter: 'agDateColumnFilter', filterParams: { buttons: ['reset', 'apply'], suppressAndOrCondition: true, comparator: function (filterLocalDateAtMidnight, cellValue) {
